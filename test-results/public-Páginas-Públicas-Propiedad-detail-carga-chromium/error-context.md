...
- Name: public.spec.js >> Páginas Públicas >> Propiedad detail carga
- Location: tests\public.spec.js:57:3
...
Locator: locator('text=Contactar Agente')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Contactar Agente')
...
- main:
  - heading "Propiedad no encontrada" [level=1]
  - link "Volver a propiedades":
    - /url: /propiedades
    - button "Volver a propiedades"
- contentinfo:
  - link "TUAGENTE.PE":
    - /url: /
